# Generated by Powerlevel10k configuration wizard on 2020-06-02 at 20:54 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{red}%B%n%b%f%b@%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_SUDO_TEMPLATE='%F{red}%B%n%b%f@%m'
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_TEMPLATE='%F{blue}%B%n%b%f@%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{blue}%B%n%b%f@%m'
